    ...
    <div class="content-header row mb-1">
        <div class="col-12">
            <div class="card-header">
                <h2> <i class="la la-user-plus font-large-2 success"></i>List of Registered Suppliers</h2>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="add_new_supplier_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="Post" action="action_supplier.php" id='cadree'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="lname" name="name" placeholder="Eg.Makame" class="form-control" tabindex="3" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="lname" name="contact_person" placeholder="Eg.Issa" class="form-control" tabindex="3" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="Cadre"> Supplier Address: </label>
                                <input type="text" id="lname" name="address" placeholder="Eg.Makame" class="form-control" tabindex="3" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="lname" name="email" placeholder="Eg.0776543211" class="form-control" tabindex="3" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="Cadre">Supplier Phone Number: </label>
                                <input type="text" id="lname" name="phone" placeholder="Eg.someone@gmail.com" class="form-control" tabindex="3" />
                            </div>
