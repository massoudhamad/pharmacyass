...
<head>
    ...
    <title>Add Patient - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-user"></i><span class="menu-title" >Patient Registration</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="add-patient.php"><i></i><span>Register Patient</span></a></li>
                        <li><a class="menu-item" href="#"><i></i><span>Triager Center</span></a></li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-folder-open"></i><span class="menu-title" data-i18n="nav.templates.main">Test Requirement</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#"><i></i><span>Test/Investigation results</span></a></li>
                        <li><a class="menu-item" href="#"><i></i><span>Radiology</span></a></li>
                        <li><a class="menu-item" href="#"><i></i><span>Ultrasonography</span></a></li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-folder"></i><span class="menu-title" data-i18n="nav.templates.main">Producer Management</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#"><i></i><span>Operation Management</span></a></li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="la la-file"></i><span class="menu-title" data-i18n="nav.templates.main">System Configuration</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="patients-list.php"><i></i><span>Manage User</span></a></li>    
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-file"></i><span class="menu-title" data-i18n="nav.templates.main">Pharmacy Management</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="patients-list.php"><i></i><span>Patient list</span></a></li>    
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-folder-open"></i><span class="menu-title" data-i18n="nav.templates.main">Reports</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#"><i></i><span>Patient Reports</span></a></li>    
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-expand"></i><span class="menu-title" data-i18n="nav.templates.main">Metadata Configuration</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#"><i></i><span>Manage Location</span></a></li> 
                        <li><a class="menu-item" href="#"><i></i><span>Manage Health Facilities</span></a></li>
                        <li><a class="menu-item" href="#"><i></i><span>Manage Services</span></a></li>
                        <li><a class="menu-item" href="#"><i></i><span>Disease Definition</span></a></li>   
                    </ul>

                </li>
                <li class=" nav-item"><a href="#"><i class="la la-user"></i><span class="menu-title" data-i18n="nav.templates.main">My Account</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#"><i></i><span>Profile Information</span></a></li>   
                        <li><a class="menu-item" href="#"><i></i><span>Change Password</span></a></li>    
                    </ul>
                </li>                
            </ul>
        </div>
    ...
    <div class="app-content content">
        <div>
            <div style="margin-left:5%;">
                <h2 >Receptionalist Center</h2>
                <form>
                    <div class="search-input">
                        <button  type="button" class="btn btn-primary">
                            <span class="la la-search"></span>
                        </button>
                        <input class="input" type="text" placeholder="search registered patient">
                    </div>
                </form>
            </div>
        </div
            ...
            <div class="content-body">
                ...
                <div class="pull-right" style="margin-right:40px">
                    <a href="add-patient.php" class="btn btn-primary round btn-sm"><i class="la la-plus font-small-2"></i>AddPatient</a>
                 </div>
                </section>
            </div>
        </div>
