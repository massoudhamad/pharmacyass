                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right" style="margin-right:40px">
                            <a class="btn btn-info round btn-sm" data-toggle="modal" data-target="#add_new_supplier_modal" style="color:white;"><i class="la la-plus font-small-2"></i>Register Product</a>
                        </div>
