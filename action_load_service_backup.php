...
try {
    ...
    //$paymenttype = ( 'http://localhost/gvt-ehr-server/data/get_insurer_type_api.php' ) or die( 'failed' );
    ...
    if ( !empty( $paymenttype_array ) ) {
        foreach ( $paymenttype_array as $payment ) {
            ...
            $paymenttypeData = array(
             ...
             if ($db->isFieldExist($tblName, 'userName', $_POST['email'])) {
                continue;
             }else{
                $paymenttypeinsert = $db->insert( 'paymenttype', $paymenttypeData );
             }     
    ...
    //$category_json = ( 'http://localhost/gvt-ehr-server/data/get_category_json_api.php' ) or die( 'failed' );
    ...
    //$subcategory_json = ( 'http://localhost/gvt-ehr-server/data/get_subcategory_json_api.php' ) or die( 'failed' );
    ...
    //$zone_url = ( 'http://localhost/gvt-ehr-server/data/get_zone_api.php' ) or die( 'failed' );
    ...
    //$region_url = ( 'http://localhost/gvt-ehr-server/data/get_region_api.php' ) or die( 'failed' );
   ...
   // $hospitallevel_url = ( 'http://localhost/gvt-ehr-server/data/get_hospitallevel_api.php' ) or die( 'failed' );
    ...
    //$allergies_url = ( 'http://localhost/gvt-ehr-server/data/get_allergies_api.php' ) or die( 'failed' );
    ...
    //$allergy_reaction_url = ( 'http://localhost/gvt-ehr-server/data/get_allergies_reaction_api.php' ) or die( 'failed' );
    ...
    //$service_json = ( 'http://localhost/gvt-ehr-server/data/get_district_apii.php' ) or die( 'failed' );
    ...
    //$shehia_url = ( 'http://localhost/gvt-ehr-server/data/get_shehia_apii.php' ) or die( 'failed' );
    ...
    //$cadre_url = ( 'http://localhost/gvt-ehr-server/data/get_cadre_api.php' ) or die( 'failed' );
   ...
   // $clini_url = ( 'http://localhost/gvt-ehr-server/data/get_clinic_api.php' ) or die( 'failed' );
     $clini_url = ( 'http://hmis.skychuo.com/data/get_clinic_api.php' ) or die( 'failed' );
    $ch = curl_init();
    curl_setopt( $ch, CURLOPT_URL, $clini_url );
    curl_setopt( $ch, CURLOPT_RETURNTRANSFER, 1 );
    curl_setopt( $ch, CURLOPT_PORT, 80 );
    $body = curl_exec( $ch );
    $error = curl_error( $ch );
    ...
    //$diseases_url = ( 'http://localhost/gvt-ehr-server/data/get_icdapi.php' ) or die( 'failed' );
    ...
    if ( !empty( $diseases_array ) ) {
        foreach ( $diseases_array as $diseases ) {
            ...
            $insert = $db->insert( 'diseases', $userData );

        }
    }


    //$department_url = ( 'http://localhost/gvt-ehr-server/data/get_department_api.php' ) or die( 'failed' );
    ...
    //$clinic_url = ( 'http://localhost/gvt-ehr-server/data/get_clinics_api.php' ) or die( 'failed' );
    ...
    //$service_json = ( 'http://localhost/gvt-ehr-server/data/get_service_api.php' ) or die( 'failed' );
     $service_json = ( 'http://hmis.skychuo.com/data/get_service_api.php' ) or die( 'failed' );
...
//         if ($db->isFieldExistMult( 'paymenttype', array( 'hospitalCode'=>$_POST['code'])) {
//     }
