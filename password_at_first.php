...
if($_SESSION['pass_error']){?>
    ...
    alertify.error("Current Password is Invalid");
    </script>
<?php
}
                        ...
                        <div class="col-lg-12 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                <div class="card-header border-0 pb-0">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>Reset Your Password To Continue</span></h6>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="change_password_force.php" method="Post" id="changePassword">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type='password' id="confirm_password" class="form-control" name="pwd_new" placeholder="Confirm New Password" required>
                                                <div class="form-control-position">
                                                    <i class="ft-unlock"></i>
                                                </div>
                                            </fieldset>
