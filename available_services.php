...
<div class="card-content">
  ...
  <div class="card-header">
   <div class="pull-right" style="margin-right:40px">
        <a href="index3.php?sp=hospital_services" class="btn btn-info  btn-sm" style="color:white;"><i class="la la-plus font-small-2"></i>Add Service</a>
    </div>
         <h2>Services</h2>
    </div><br>
...
<?php  
 $service = $db->getRows('serviceoffered',array('order_by'=>'serviceOfferedID asc'));
?>
        ...
        ?>
            <tr>
                <td><?php echo $count;?></td>
                 <td><?php echo  $db->getData("service","serviceName","serviceCode",$inst['serviceCode']);?></td>
                  <td><?php  if($inst['isActive'] == 1){echo 'Available';}else{echo ' Not Available';}?></td>
                 <td>
                 <?php  if($inst['isActive'] == 1){?>
                 <a href='block_service_offered.php?serviceCode=<?php echo $inst['serviceCode'];?>' class="btn  btn-danger btn-sm" style="color:white;"  title="Click to block" ><i class="ft-shield default"></i></a>
                 <?php }else{?>
                     <a href='unblock_service_offered.php?serviceCode=<?php echo $inst['serviceCode'];?>' class="btn  btn-success btn-sm" style="color:white;"  title="Click to unblock" ><i class="ft-shield default"></i></a>
                     <?php
                 }
                 ?>
                  </td>
