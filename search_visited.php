...
<div class="card-body">
        <div class="card">
             <div  class="card-header">
                 <h2> <i class="la la-user-plus font-large-2 warning"></i>  Register New Visit</h2>
            </div>
        </div>
        <div class="col-md-12">
        <div class="card-header">
        <div class="content-header-left col-md-12 col-12 mb-2">
            ...
            <div class="row">
                ...
                <div class="autocomplete" style="width:360px;">
                    <label><br></label><input type="text" name="searchQuery" id="search" class="form-control" placeholder="Search Registered Patient to Add a Visit" autocomplete="off"/>
                ...
                <section id="add-patient">
                    <div class="pull-right" style="margin-left:1100px;">
                         <a href="index3.php?sp=add_patient" class="btn btn-info" style="color:white;margin-top:27px;width:200px;" id="tag"><i class="la la-plus font-small-2"></i> Register New Patient</a>
                    </div>
                  </section>
