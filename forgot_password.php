                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="action_forgot_password.php"
                                            id="login-form">
                                            ...
                                            <button type="submit" class="btn btn-outline-info btn-block" name="doLogin"
                                                id="login-submit" value="Log In"><i class="ft-unlock"></i>
                                                Submit</button>
                                            <br>
