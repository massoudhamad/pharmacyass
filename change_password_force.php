...
//check for old password in md5 format
    if($password === $auth_user->PwdHash($_POST['pwd_old'],$old_salt))
    {
        ...
        $_SESSION['msg_pass'] = 'Password Changed Successfully';
        header("Location:index3.php");
    } 
    else{
        $err = "Your old password is invalid";
        $_SESSION['pass_error'] = $err;
        header("Location:index3.php?msg=Your old password is invalid"); 
        //$err[] = "Your old password is invalid";
    }
}
}
    ...
    //echo $ex;
    $_SESSION['error'] = $err;
 header("Location:index3.php?msg=error_changing_password");
 }
?>